...
export function AEOBlock({
  ...
  return (
    <Reveal y={20}>
      <div className="w-full p-6 sm:p-8 md:p-10 rounded-3xl border border-white/5 bg-white/[0.02] hover:bg-white/[0.04] transition-all group relative overflow-hidden mb-8 shadow-2xl">
