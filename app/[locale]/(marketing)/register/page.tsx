        ...
        <div className="relative z-10 w-full max-w-md space-y-8 flex flex-col items-center">
          ...
          <div className="w-full bg-[#0F0F12] text-white rounded-2xl p-7 shadow-2xl border border-white/5 relative">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-1">
                    <span className="text-[13px] font-bold text-white">Marcus Jenkins</span>
                    {/* Verified check */}
                    <svg className="w-4 h-4 text-[#C0F0FB] fill-current" viewBox="0 0 24 24">
                      <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" />
                    </svg>
                  </div>
                  <div className="text-[11px] text-neutral-400 font-mono">@mjenkins_tech</div>
                </div>
              </div>
            ...
            <p className="text-[15px] leading-relaxed text-neutral-200 mb-6 font-normal">
              Building our autonomous customer outreach framework with <span className="text-[#C0F0FB]">@growxlabs</span> was seamless. The automation workflows they deployed in just 7 days are absolute magic.
            </p>

            <div className="text-[10px] text-neutral-500 font-mono flex items-center gap-2 border-t border-neutral-900 pt-4">
              <span>3:12 PM · May 14, 2026</span>
              <span>·</span>
              <span className="text-[#C0F0FB]">8.9K Views</span>
            </div>
          </div>
        </div>
      </div>
