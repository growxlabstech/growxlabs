    ...
    <div className="bg-card border border-border rounded-2xl p-8 md:p-12 relative overflow-hidden shadow-sm my-16 text-center max-w-3xl mx-auto border-t-4 border-t-[#355CFF]">
      ...
      <div className="relative z-10 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
          <Link
            href="/contact"
            className="w-full sm:w-auto bg-[#355CFF] hover:bg-[#355CFF]/90 text-white font-bold text-[15px] px-8 py-4 rounded-xl transition-all duration-300 active:scale-[0.98] shadow-md shadow-[#355CFF]/10 text-center"
          >
