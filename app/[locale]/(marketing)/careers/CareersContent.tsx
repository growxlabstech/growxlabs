...
export function CareersContent() {
  ...
  return (
    <div className="fixed inset-0 w-full h-full bg-transparent text-white font-sans z-40 flex flex-col justify-between pt-28 pb-8 px-8 md:pt-32 md:pb-12 md:px-12 xl:pt-36 xl:pb-16 xl:px-16 select-none overflow-hidden">
